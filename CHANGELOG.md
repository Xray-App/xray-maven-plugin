...
- no changes; just version bump test

## [0.11.1] - 2026-03-20

### Fixed

- fixed signing of packages before deployment

## [0.11.0] - 2026-03-20

### Added

- fixes #99 (split logic of client lib and maven plugin to multi-module project) by @dve and @bitcoder in #101

## [0.10.0] - 2025-11-12

### Added

- fixes #94 (bump deps) by @bitcoder in #95
